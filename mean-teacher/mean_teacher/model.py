...
# TODO this function has logic for setting up student and teacher models
...
# TODO this sets up the supervised model structure (tower), same for teacher and student. 
# It's where all the conv layers, softmaxes, etc are getting set. 
def tower(inputs,
          is_training,
          dropout_probability,
          input_noise,
